  ...
  return product && (
    <div className="mt-12">
      <p>
        ...
        <span span className="text-primary"> {product.name}</span>
      </p>
      ...
      <div className="flex flex-col md:flex-row gap-16 mt-4">
       ...
       <div className='flex flex-col items-center mt-20'>
        ...
        <div className='grid grid-cols-2 sm:grid-cols-4 gap-3 md:gap-6 lg:grid-cols-5 mt-6 w-full'>
